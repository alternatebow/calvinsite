 ...
 *
 */
public class SecondEntryWayListDriver {
	// public main
	public static void main(String... args) {
		new SecondEntryWayListDriver().run();
	}	
	// run
	private void run() {
		// display an empty list
		SecondEntryWayList<Integer> iList = new SecondEntryWayList<Integer>();
		iList.display();
		// add five entries to the list- some at the head and some at the tail
		iList.insertHead(3);
		iList.insertHead(2);
		...
		// repeat for strings
		// display an empty list
		SecondEntryWayList<String> sList = new SecondEntryWayList<String>();
		sList.display();
		// add five entries to the list- some at the head and some at the tail
