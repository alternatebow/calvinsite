...
public class LList<T> implements ListInterface<T> {
	...
	public T findThirdFromLast(Node<T> firstNode){
		T currentNode = firstNode;
		while(!nodeSensor(3, firstNode) || !exactAmount(3, firstNode)){
			currentNode = currentNode.next;
		}
		return currentNode;
	}

	private boolean nodeSensor(int stepsAhead, Node<T> selNode){
		Node<T> currentNode = selNode;
	...
	private boolean exactAmount(int stepsAhead, Node<T> selNode){
		Node<T> currentNode = selNode;
		for(int i = 1; i <= stepsAhead; i++){
